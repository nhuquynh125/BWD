...
const HERITAGE_SEED = [
  ...
  { name: 'Cao nguyên đá Đồng Văn', province: 'Hà Giang', categories: ['Địa chất', 'Văn hóa'], type: 'địa chất', unesco: 2010, page: 'cao-nguyen-da-dong-van.html', image_url: './uploads/ex/cao-nguyen-da-dong-van.jpg', description: 'Đá vôi 500 triệu năm, 17 dân tộc, con đường Hạnh Phúc.', lat: 23.2758, lng: 105.3622 },
